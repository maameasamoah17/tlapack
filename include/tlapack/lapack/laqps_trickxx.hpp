...
#ifndef TLAPACK_LAQPS_TRICKXX_HH
    #define TLAPACK_LAQPS_TRICKXX__HH
...
inline constexpr void laqps_trickxx_worksize(
    const matrix_t& A,
...
int laqps_trickxx(size_type<matrix_t>& offset,  // will need to be removed,
                  ...
                  const laqps_trickxx_opts_t<size_type<matrix_t>>& opts = {})
{
...
//         laqps_trickxx(offset, kb, Akk, jpvtk, tauk, partial_normsk,
//                       exact_normsk, opts_laqps);
